...
| FR-003 | developer | use button 1 actions for validation | I can test heartbeat and crash reporting quickly | Short press triggers heartbeat path; long press triggers demo crash path | [app-memfault-module.md](../dev-specs/app-memfault-module.md) (button events via zego/button) |
| FR-004 | developer | use button 2 actions for OTA/fault validation | I can validate update and fault handling flows | Short press triggers OTA check; long press triggers demo crash path | [app-memfault-module.md](../dev-specs/app-memfault-module.md) (button events via zego/button) |
